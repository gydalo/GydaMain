    ...
    <Layout>
      <>
        ...
        <p>
          ...
          booking and hosting functionality by registering and logging in with a{" "}
          <code>@stud.noroff.no</code> email. The page is designed to simulate a
          vacation rental platform, allowing users to experience both booking
          and managing venues.
        </p>
        ...
        <p>
          ...
          I’m not super happy with how the design turned out, but it was okay. I
          would probably do it differently if I could start over. I tried to
        ...
        <p>
          ...
          little scared at the beginning, thinking it would be overwhelming, but
          I found TypeScript to be nice to use.
        </p>
        ...
        <ul>
          ...
          <li>
            Booking System: Users can select dates, check availability, and get
            a full price breakdown before confirming a booking
          </li>
          <li>
          ...
          <li>
            Dynamic Calendar: Prevents double bookings and disables unavailable
            dates
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>Venue managers can also create and manage their own listings</li>
          <li>
            Both users can update their bio, avatar, and banner on their profile
            page
          </li>
        </ul>
      </>
